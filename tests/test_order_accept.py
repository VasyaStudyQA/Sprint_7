...
class TestOrderAccept:
    ...
    def test_accept_order_no_courier_id_error(self, order):
        ...
        assert accept_json['message'] == ErrorMessages.accept_order_no_courier 
        assert accept_status == 400
    ...
    def test_accept_order_wrong_courier_id_error(self, order):
        ...
        assert accept_json['message'] == ErrorMessages.accept_order_wrong_courier_id 
    ...
    def test_accept_order_no_order_id_error(self, courier):
        ...
        assert accept_json['message'] == ErrorMessages.not_found 
        assert accept_status == 404
    ...
    def test_accept_order_wrong_order_id_error(self, courier):
        ...
        assert accept_json['message'] == ErrorMessages.accept_order_wrong_order_id 
        assert accept_status == 404        